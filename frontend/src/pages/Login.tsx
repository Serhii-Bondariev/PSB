...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent): Promise<void> => {
    ...
    try {
      ...
      console.log('Користувач після логіну:', user);
      if (user) {
        if (user.role === 'admin' || user.role === 'moderator') {
          navigate('/admin/dashboard');
          console.log('Редирект на адмінку');
        } else {
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="max-w-md mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
          <div className="bg-primary text-white p-6 text-center">
            <h1 className="text-2xl font-bold">Вхід до адміністративної панелі</h1>
          ...
          <div className="p-6">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className={`w-full bg-primary text-white py-3 rounded-lg font-bold hover:bg-dark transition-colors ${
